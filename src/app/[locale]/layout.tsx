...
const twitterImages = DATA_SEO_DEFAULT.twitter.images.map(img => (img.startsWith('https') ? img : `${baseUrl}${img}`))
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${NEXT_PUBLIC_BASE_URL}` || DATA_SEO_DEFAULT.alternates.canonical,
  },
  openGraph: {
...
export default async function RootLayout({ children, params }: LayoutProps) {
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <body
        className={`${geistSans.variable} ${inter.variable} overflow-x-hidden antialiased`}
