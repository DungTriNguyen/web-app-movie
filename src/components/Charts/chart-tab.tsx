...
export default function ChartTab() {
    ...
    if (isLoading) {
        {/* Loading State */ }
        return (
            <div className="max-w-[480px] w-full h-full md:shadow-[20px_20px_0px_0px_rgba(0,0,0,0.2)] bg-background rounded-2xl p-4 md:p-9 gap-9 justify-center items-center md:border-[16px] md:border-background animate-pulse">
                <div className="flex flex-1 w-full items-center justify-between gap-4 self-stretch border-b-2 border-border mb-4">
                ...
                {[...Array(5)].map((_, i) => (
                    <div key={i} className="flex self-stretch gap-2.5 items-center px-1 min-h-14 h-14 mb-2">
                        <div className="flex flex-1 gap-2 items-center">
                            <div className="rounded-full bg-slate-800 w-6 h-6" />
                            <div className="h-4 w-16 bg-slate-800 rounded" />
                            <div className="h-4 w-8 bg-slate-800 rounded" />
                        </div>
                        <div className="flex min-w-28 items-center justify-end max-w-40 text-right">
                            <div className="h-4 w-16 bg-slate-800 rounded" />
                        </div>
                        <div className="flex-1 text-right min-w-28 max-w-40">
