        ...
        <div className="w-full">
            <div className="flex gap-2 pl-3">
                ...
                >
                    ...
                    <p className={`text-xs font-normal font-['Inter'] leading-tight ${liked ? 'text-rose-500' : 'text-white'}`}>{t("like")}</p>
                </button>
                ...
                <ShareDialog trigger={
                    <button className="flex items-center gap-1 cursor-pointer">
                        ...
                        <p className="text-white text-xs font-normal font-['Inter'] leading-tight">{t("share")}</p>
                    </button>
                } />
                <div className="w-px self-stretch bg-gray-700" />
                <button className="flex items-center gap-1 cursor-pointer">
                    ...
                    <p className="text-white text-xs font-normal font-['Inter'] leading-tight">{t("comment")}</p>
                </button>
            </div>
        </div>
    );
