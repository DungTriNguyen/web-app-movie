        ...
        <div className="w-full">
            <div className="flex gap-2 pl-3">
                ...
                >
                    ...
                    <p className={`text-xs font-medium font-['Inter'] leading-tight cursor-pointer ${liked ? 'text-rose-500' : 'text-white'}`}>{t("like")}</p>
                </button>
                ...
                <button className="flex items-center gap-1">
                    ...
                    <p className="text-white text-xs font-medium font-['Inter'] leading-tight cursor-pointer">{t("share")}</p>
                </button>
                <div className="w-px self-stretch bg-gray-700" />
                <button className="flex items-center gap-1">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="text-white text-xs font-medium font-['Inter'] leading-tight cursor-pointer">{t("comment")}</p>
                </button>
            </div>
        </div>
    );
