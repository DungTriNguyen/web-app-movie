...
export default function Ready() {
    ...
    return (
        <section id="ready" className="py-16 bg-slate-900">
            <div className="w-full bg-[url('/images/ready.jpeg')] bg-cover bg-center bg-no-repeat gap-4 bg-background text-center rounded-2xl md:rounded-none flex-col flex self-stretch py-[46px] px-6">
