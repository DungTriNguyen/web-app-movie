    ...
    return (
        ...
        >
            <div className="flex w-full h-full justify-center gap-12 self-stretch flex-col-reverse md:flex-row relative">
                <div className="flex flex-1 flex-col justify-center items-end gap-12 bg-[url('/images/token-trade.png')] bg-contain bg- bg-no-repeat">
                    {/* <Image
                        src="/images/token-trade.png"
                        alt="token trade"
                        className="w-full flex flex-col justify-end items-start gap-8 rounded-2xl border-2 border-border bg-background shadow-[-20px_-20px_0px_0px_rgba(17,24,39,0.8)] h-[868px] aspect-[479/268]"
                        width={1390}
                        height={868}
                    /> */}
                    <div className="bg-[url('/images/token-trade.png')] bg-cover bg-center bg-no-repeat"></div>
                ...
                <div className="flex-1 justify-center flex flex-col py-9 gap-6">
                    <h1 className="max-w-[600px] text-4xl md:text-5xl font-bold flex flex-col gap-4 items-start self-stretch">
                        ...
                        <p className="text-muted-foreground text-base font-normal">
                            Track market movements, analyze trends, and make informed decisions with our powerful analytics suite.
                        </p>
                    </h1>
