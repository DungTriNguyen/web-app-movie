...
export default function Hero() {
   ...
   max-md:bg-lightgray">
            <div className="flex flex-col gap-6 items-start justify-center py-9 flex-1 md:mx-auto md:container self-stretch">
                <h1 className="text-center md:text-left text-4xl md:text-5xl lg:text-6xl font-bold max-w-[700px]">
                    {t('title')}
                </h1>
                <p className="text-sm max-w-[700px] text-gray-300 text-center md:text-left">
                    {t('description')}
                </p>
